...
|------------------------- |-------------- |------------:|------:|----------:|------------:|
| EnumerateLines_BCL       | 0             | 3,294.14 μs |  1.00 |         - |          NA |
| EnumerateLines_SimdSharp | 0             |   527.54 μs |  0.16 |         - |          NA |
|                          |               |             |       |           |             |
| EnumerateLines_BCL       | 8             | 1,221.17 μs |  1.00 |         - |          NA |
| EnumerateLines_SimdSharp | 8             |   317.60 μs |  0.26 |         - |          NA |
|                          |               |             |       |           |             |
