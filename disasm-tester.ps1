...
dumpbin /DISASM /SYMBOLS "artifacts\publish\SimdSharp.Tester\release_$runtime\SimdSharp.Tester.exe" > "artifacts\publish\SimdSharp.Tester\release_$runtime\disassembly.asm"
